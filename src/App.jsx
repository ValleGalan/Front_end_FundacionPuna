  ...
  return (
    <BrowserRouter>
      <Routes>
          ...
          <Route path={RouteValues} element={<Values />} />
          <Route path={RouteMission} element={<Mission />} />
          <Route path={RouteAboutUs} element={<AboutUs />} />
          <Route path={RouteContact} element={<Contact />} />
          <Route path={RoutePaymentForm} element={<PaymentForm />}/>
